...
{
    private String CategoryName, Description, Price, Pname, saveCurrentDate, saveCurrentTime, SerialNumber;
    private Button AddNewProductButton;
    private ImageView InputProductImage;
    private EditText InputProductName, InputProductDescription, InputProductPrice, InputSerialNumber;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        InputSerialNumber = (EditText) findViewById(R.id.product_serial);
    ...
    private void ValidateProductData()
    {
        ...
        SerialNumber = InputSerialNumber.getText().toString();
        ...
        {
            Toast.makeText(this, "Product serial number is mandatory. Products cannot be approved without valid serial number", Toast.LENGTH_SHORT).show();
        }
        else
        {
                ...
                Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task)
                    {
                        if (task.isSuccessful())
                        {
                            ...
                            Toast.makeText(SellerAddNewProductActivity.this, "Product image URL generated successfully...", Toast.LENGTH_SHORT).show();
    ...
    private void SaveProductInfoToDatabase()
    {
        ...
        productMap.put("serialNumber", SerialNumber);
        ...
        productMap.put("productState", "Pending Approval");
