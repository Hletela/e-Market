...
public class AdminCheckNewProductsActivity extends AppCompatActivity {
    ...
    protected void onStart()
    {
        ...
        FirebaseRecyclerOptions<Products> options = new FirebaseRecyclerOptions.Builder<Products>()
                .setQuery(unverifiedProductsRef.orderByChild("productState").equalTo("Pending Approval"), Products.class)
                .build();
...
//                        holder.txtSerial.setText(model.getSerial());
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view)
                            {
                                ...
                                builder.setTitle("Approve Product?");
    ...
    private void rejectProduct(String productID)
    {
        unverifiedProductsRef.child(productID)
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    {
                        Toast.makeText(AdminCheckNewProductsActivity.this, "Product Rejected.", Toast.LENGTH_SHORT).show();
                    }
                });
    }
