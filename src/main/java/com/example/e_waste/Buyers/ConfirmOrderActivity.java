...
public class ConfirmOrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        postalCodeEditText = (EditText) findViewById(R.id.shipment_city_code);
    ...
    private void Check()
    {
        ...
        {
            Toast.makeText(this, "Please enter package receiver's name", Toast.LENGTH_SHORT).show();
        }
        else if (TextUtils.isEmpty(phoneEditText.getText().toString()))
        {
            Toast.makeText(this, "Please enter package receiver's phone number", Toast.LENGTH_SHORT).show();
        }
        ...
        else if (TextUtils.isEmpty(cityEditText.getText().toString()))
        {
            ...
            Toast.makeText(this, "Please provide your city's postal code.", Toast.LENGTH_SHORT).show();
        }
        else
        {
            ConfirmOrder();
