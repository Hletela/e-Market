...
public class SettingsActivity extends AppCompatActivity
{
    ...
    private EditText fullNameEditText, userPhoneEditText, userEmailEditText, addressEditText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userInfoDisplay(profileImageView, fullNameEditText, userPhoneEditText, userEmailEditText, addressEditText);
    ...
    private void updateOnlyUserInfo()
    {
        ...
        userMap. put("cellPhone", userPhoneEditText.getText().toString());
    ...
    private void userInfoSaved()
    {
        ...
        {
            Toast.makeText(this, "Please enter a cellphone number.", Toast.LENGTH_SHORT).show();
        }
    ...
    private void uploadImage()
    {
        ...
        progressDialog.setMessage("Please wait while your details are being updated");
    ...
    private void userInfoDisplay(final CircleImageView profileImageView, final EditText fullNameEditText, final EditText userPhoneEditText, final EditText userEmailEditText, final EditText addressEditText)
    {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                if(dataSnapshot.exists())
                {
                    if(dataSnapshot.child("image").exists())
                    {
                        ...
                        //String phone = dataSnapshot.child("cellphone").getValue().toString();
                        String email = dataSnapshot.child("email").getValue().toString();
                        String address = dataSnapshot.child("address").getValue().toString();

                        Picasso.get().load(pimage).into(profileImageView);
