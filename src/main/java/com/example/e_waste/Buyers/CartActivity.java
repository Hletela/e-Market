...
import com.example.e_waste.Model.Cart;
import com.example.e_waste.Prevalent.Prevalent;
import com.example.e_waste.R;
import com.example.e_waste.ViewHolder.CartViewHolder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NextProcessBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                txtTotalAmount.setText("Total Price = R" + String.valueOf(overallTotalPrice));
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Cart, CartViewHolder> adapter
            ...
            protected void onBindViewHolder(@NonNull CartViewHolder holder, int i, @NonNull final Cart model) {
                ...
                overallTotalPrice = overallTotalPrice + oneProductTPrice;
                txtTotalAmount.setText("Total Price = R" + String.valueOf(overallTotalPrice));
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    if (shippingState.equals("Shipped")) {
                        ...
                        txtMsg1.setText("Congratulations, your order has been shipped. It will soon be delivered to your specified address.");
